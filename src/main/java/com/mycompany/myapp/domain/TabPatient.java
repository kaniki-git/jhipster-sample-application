...
public class TabPatient implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    private Set<TabAdministratif> tabAdministratifs = new HashSet<>();
    ...
    public Set<TabAdministratif> getTabAdministratifs() {
        return tabAdministratifs;
    }

    public TabPatient tabAdministratifs(Set<TabAdministratif> tabAdministratifs) {
        this.tabAdministratifs = tabAdministratifs;
        return this;
    }

    public TabPatient addTabAdministratif(TabAdministratif tabAdministratif) {
        this.tabAdministratifs.add(tabAdministratif);
        tabAdministratif.setTabPatient(this);
        return this;
    }

    public TabPatient removeTabAdministratif(TabAdministratif tabAdministratif) {
        this.tabAdministratifs.remove(tabAdministratif);
        tabAdministratif.setTabPatient(null);
        return this;
    }

    public void setTabAdministratifs(Set<TabAdministratif> tabAdministratifs) {
        this.tabAdministratifs = tabAdministratifs;
    }
