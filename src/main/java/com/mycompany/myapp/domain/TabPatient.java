...
public class TabPatient implements Serializable {
    ...
    public TabPatient tabSerologies(Set<TabSerologie> tabSerologies) {
        this.tabSerologies = tabSerologies;
        return this;
    }

    public TabPatient addTabSerologie(TabSerologie tabSerologie) {
        this.tabSerologies.add(tabSerologie);
        tabSerologie.setTabPatient(this);
        return this;
    }

    public TabPatient removeTabSerologie(TabSerologie tabSerologie) {
        this.tabSerologies.remove(tabSerologie);
        tabSerologie.setTabPatient(null);
        return this;
    }
    ...
    public TabPatient tabPersonnel(TabPersonnel tabPersonnel) {
