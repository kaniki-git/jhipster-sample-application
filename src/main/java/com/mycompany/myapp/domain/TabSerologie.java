...
public class TabSerologie implements Serializable {
    ...
    public TabGrossesse getTabGrossesse() {
        return tabGrossesse;
    }

    public TabSerologie tabGrossesse(TabGrossesse tabGrossesse) {
        this.tabGrossesse = tabGrossesse;
        return this;
    }

    public void setTabGrossesse(TabGrossesse tabGrossesse) {
        this.tabGrossesse = tabGrossesse;
    }
