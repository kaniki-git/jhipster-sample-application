...
public class TabParamVitaux implements Serializable {
    ...
    @Column(name = "examen_compl")
    private String examenCompl;
    ...
    public TabParamVitaux examenPhysique(String examenPhysique) {
    ...
    public String getExamenCompl() {
        return examenCompl;
    }

    public TabParamVitaux examenCompl(String examenCompl) {
        this.examenCompl = examenCompl;
        return this;
    }

    public void setExamenCompl(String examenCompl) {
        this.examenCompl = examenCompl;
    }
    ...
    public TabParamVitaux evolution(String evolution) {
    ...
    public TabUrgence getTabUrgence() {
        return tabUrgence;
    }

    public TabParamVitaux tabUrgence(TabUrgence tabUrgence) {
        this.tabUrgence = tabUrgence;
        return this;
    }

    public void setTabUrgence(TabUrgence tabUrgence) {
        this.tabUrgence = tabUrgence;
    }
    ...
    public TabParamVitaux tabHospital(TabHospital tabHospital) {
    ...
    public String toString() {
        return "TabParamVitaux{" +
            ...
            ", sous=" + getSous() +
            ", poids=" + getPoids() +
            ", examenPhysique='" + getExamenPhysique() + "'" +
            ", examenCompl='" + getExamenCompl() + "'" +
