...
public class TabPersonnel implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnore
    private Set<TabAccouchement> tabAccouchements = new HashSet<>();
    ...
    public Set<TabAccouchement> getTabAccouchements() {
        return tabAccouchements;
    }

    public TabPersonnel tabAccouchements(Set<TabAccouchement> tabAccouchements) {
        this.tabAccouchements = tabAccouchements;
        return this;
    }

    public TabPersonnel addTabAccouchement(TabAccouchement tabAccouchement) {
        this.tabAccouchements.add(tabAccouchement);
        tabAccouchement.getTabPersonnels().add(this);
        return this;
    }

    public TabPersonnel removeTabAccouchement(TabAccouchement tabAccouchement) {
        this.tabAccouchements.remove(tabAccouchement);
        tabAccouchement.getTabPersonnels().remove(this);
        return this;
    }

    public void setTabAccouchements(Set<TabAccouchement> tabAccouchements) {
        this.tabAccouchements = tabAccouchements;
    }
