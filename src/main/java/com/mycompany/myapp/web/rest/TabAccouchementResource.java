...
public class TabAccouchementResource {
    ...
    public List<TabAccouchement> getAllTabAccouchements(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all TabAccouchements");
        return tabAccouchementRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<TabAccouchement> getTabAccouchement(@PathVariable Long id) {
        ...
        Optional<TabAccouchement> tabAccouchement = tabAccouchementRepository.findOneWithEagerRelationships(id);
