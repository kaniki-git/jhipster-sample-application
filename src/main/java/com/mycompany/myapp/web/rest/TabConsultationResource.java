...
public class TabConsultationResource {
    ...
    public List<TabConsultation> getAllTabConsultations() {
        log.debug("REST request to get all TabConsultations");
        return tabConsultationRepository.findAll();
    }
    ...
    public ResponseEntity<TabConsultation> getTabConsultation(@PathVariable Long id) {
        ...
        Optional<TabConsultation> tabConsultation = tabConsultationRepository.findById(id);
