...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.TabPatient.class.getName() + ".tabAdministratifs");
            ...
            createCache(cm, com.mycompany.myapp.domain.TabRefFonction.class.getName());
            createCache(cm, com.mycompany.myapp.domain.TabRefPays.class.getName());
