...
export class TabUrgenceService {
  ...
  protected convertDateFromClient(tabUrgence: ITabUrgence): ITabUrgence {
    const copy: ITabUrgence = Object.assign({}, tabUrgence, {
      ...
      dateDepartUrgence:
        tabUrgence.dateDepartUrgence && tabUrgence.dateDepartUrgence.isValid() ? tabUrgence.dateDepartUrgence.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.dateDepartUrgence = res.body.dateDepartUrgence ? moment(res.body.dateDepartUrgence) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((tabUrgence: ITabUrgence) => {
        ...
        tabUrgence.dateDepartUrgence = tabUrgence.dateDepartUrgence ? moment(tabUrgence.dateDepartUrgence) : undefined;
      });
    }
    return res;
  }
