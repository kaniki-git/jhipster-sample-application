...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'tab-grossesse',
        loadChildren: () => import('./tab-grossesse/tab-grossesse.module').then(m => m.JhipsterSampleApplicationTabGrossesseModule),
      },
      {
        path: 'tab-exam-tech',
        loadChildren: () => import('./tab-exam-tech/tab-exam-tech.module').then(m => m.JhipsterSampleApplicationTabExamTechModule),
      },
      {
        path: 'tab-serologie',
        loadChildren: () => import('./tab-serologie/tab-serologie.module').then(m => m.JhipsterSampleApplicationTabSerologieModule),
      },
      {
        path: 'tab-urgence',
