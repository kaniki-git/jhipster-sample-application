...
export class TabUserProfilUpdateComponent implements OnInit {
  ...
  updateForm(tabUserProfil: ITabUserProfil): void {
    this.editForm.patchValue({
      id: tabUserProfil.id,
      usrId: tabUserProfil.usrId,
      profileID: tabUserProfil.profileID,
      ...
      dateModif: tabUserProfil.dateModif ? tabUserProfil.dateModif.format(DATE_TIME_FORMAT) : null,
