...
public class TabUrgenceResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DATE_DEPART_URGENCE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATE_DEPART_URGENCE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static TabUrgence createEntity(EntityManager em) {
        TabUrgence tabUrgence = new TabUrgence()
            ...
            .dateDepartUrgence(DEFAULT_DATE_DEPART_URGENCE)
    ...
    public static TabUrgence createUpdatedEntity(EntityManager em) {
        TabUrgence tabUrgence = new TabUrgence()
            ...
            .dateDepartUrgence(UPDATED_DATE_DEPART_URGENCE)
    ...
    public void createTabUrgence() throws Exception {
        ...
        assertThat(testTabUrgence.getDateDepartUrgence()).isEqualTo(DEFAULT_DATE_DEPART_URGENCE);
    ...
    public void getAllTabUrgences() throws Exception {
        ...
        restTabUrgenceMockMvc.perform(get("/api/tab-urgences?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateDepartUrgence").value(hasItem(sameInstant(DEFAULT_DATE_DEPART_URGENCE))))
    ...
    public void getTabUrgence() throws Exception {
        ...
        restTabUrgenceMockMvc.perform(get("/api/tab-urgences/{id}", tabUrgence.getId()))
            ...
            .andExpect(jsonPath("$.dateDepartUrgence").value(sameInstant(DEFAULT_DATE_DEPART_URGENCE)))
    ...
    public void updateTabUrgence() throws Exception {
        ...
        assertThat(testTabUrgence.getDateDepartUrgence()).isEqualTo(UPDATED_DATE_DEPART_URGENCE);
