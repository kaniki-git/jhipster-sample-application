...
public class TabAccouchementResourceIT {
    ...
    private static final String DEFAULT_PRENON_BEBE = "AAAAAAAAAA";
    private static final String UPDATED_PRENON_BEBE = "BBBBBBBBBB";
    ...
    @Mock
    private TabAccouchementRepository tabAccouchementRepositoryMock;
    ...
    public static TabAccouchement createEntity(EntityManager em) {
        TabAccouchement tabAccouchement = new TabAccouchement()
            ...
            .prenonBebe(DEFAULT_PRENON_BEBE)
    ...
    public static TabAccouchement createUpdatedEntity(EntityManager em) {
        TabAccouchement tabAccouchement = new TabAccouchement()
            ...
            .prenonBebe(UPDATED_PRENON_BEBE)
    ...
    public void createTabAccouchement() throws Exception {
        ...
        assertThat(testTabAccouchement.getPrenonBebe()).isEqualTo(DEFAULT_PRENON_BEBE);
    ...
    public void getAllTabAccouchements() throws Exception {
        ...
        restTabAccouchementMockMvc.perform(get("/api/tab-accouchements?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].prenonBebe").value(hasItem(DEFAULT_PRENON_BEBE)))
    ...
    public void getAllTabAccouchementsWithEagerRelationshipsIsEnabled() throws Exception {
        when(tabAccouchementRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));

        restTabAccouchementMockMvc.perform(get("/api/tab-accouchements?eagerload=true"))
            .andExpect(status().isOk());

        verify(tabAccouchementRepositoryMock, times(1)).findAllWithEagerRelationships(any());
    }

    @SuppressWarnings({"unchecked"})
    public void getAllTabAccouchementsWithEagerRelationshipsIsNotEnabled() throws Exception {
        when(tabAccouchementRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
    ...
    public void getTabAccouchement() throws Exception {
        ...
        restTabAccouchementMockMvc.perform(get("/api/tab-accouchements/{id}", tabAccouchement.getId()))
            ...
            .andExpect(jsonPath("$.prenonBebe").value(DEFAULT_PRENON_BEBE))
    ...
    public void updateTabAccouchement() throws Exception {
        ...
        assertThat(testTabAccouchement.getPrenonBebe()).isEqualTo(UPDATED_PRENON_BEBE);
