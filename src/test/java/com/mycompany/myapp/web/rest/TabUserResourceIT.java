...
public class TabUserResourceIT {
    ...
    private static final String DEFAULT_D_MAJ_MDP = "AAAAAAAAAA";
    private static final String UPDATED_D_MAJ_MDP = "BBBBBBBBBB";
    ...
    public void createTabUser() throws Exception {
        ...
        assertThat(testTabUser.getUserId()).isEqualTo(DEFAULT_USER_ID);
        ...
        assertThat(testTabUser.getdMajMdp()).isEqualTo(DEFAULT_D_MAJ_MDP);
        ...
        assertThat(testTabUser.getResetKey()).isEqualTo(DEFAULT_RESET_KEY);
        assertThat(testTabUser.getResetDate()).isEqualTo(DEFAULT_RESET_DATE);
    }
    ...
    public void getAllTabUsers() throws Exception {
        ...
        restTabUserMockMvc.perform(get("/api/tab-users?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dMajMdp").value(hasItem(DEFAULT_D_MAJ_MDP)))
    ...
    public void getTabUser() throws Exception {
        ...
        restTabUserMockMvc.perform(get("/api/tab-users/{id}", tabUser.getId()))
            ...
            .andExpect(jsonPath("$.dMajMdp").value(DEFAULT_D_MAJ_MDP))
    ...
    public void updateTabUser() throws Exception {
        ...
        TabUser testTabUser = tabUserList.get(tabUserList.size() - 1);
        assertThat(testTabUser.getUserId()).isEqualTo(UPDATED_USER_ID);
        ...
        assertThat(testTabUser.getdMajMdp()).isEqualTo(UPDATED_D_MAJ_MDP);
        ...
        assertThat(testTabUser.getResetKey()).isEqualTo(UPDATED_RESET_KEY);
        assertThat(testTabUser.getResetDate()).isEqualTo(UPDATED_RESET_DATE);
    }
