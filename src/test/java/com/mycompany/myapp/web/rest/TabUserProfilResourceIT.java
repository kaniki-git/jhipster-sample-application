...
public class TabUserProfilResourceIT {
    ...
    private static final Integer DEFAULT_USR_ID = 1;
    private static final Integer UPDATED_USR_ID = 2;
    ...
    public void createTabUserProfil() throws Exception {
        ...
        assertThat(testTabUserProfil.getUsrId()).isEqualTo(DEFAULT_USR_ID);
        assertThat(testTabUserProfil.getProfileID()).isEqualTo(DEFAULT_PROFILE_ID);
    ...
    public void updateTabUserProfil() throws Exception {
        ...
        TabUserProfil testTabUserProfil = tabUserProfilList.get(tabUserProfilList.size() - 1);
        assertThat(testTabUserProfil.getUsrId()).isEqualTo(UPDATED_USR_ID);
        assertThat(testTabUserProfil.getProfileID()).isEqualTo(UPDATED_PROFILE_ID);
