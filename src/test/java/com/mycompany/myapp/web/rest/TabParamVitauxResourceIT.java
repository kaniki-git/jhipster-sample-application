...
public class TabParamVitauxResourceIT {
    ...
    private static final String DEFAULT_EXAMEN_PHYSIQUE = "AAAAAAAAAA";
    private static final String UPDATED_EXAMEN_PHYSIQUE = "BBBBBBBBBB";

    private static final String DEFAULT_EXAMEN_COMPL = "AAAAAAAAAA";
    private static final String UPDATED_EXAMEN_COMPL = "BBBBBBBBBB";

    private static final String DEFAULT_EVOLUTION = "AAAAAAAAAA";
    private static final String UPDATED_EVOLUTION = "BBBBBBBBBB";
    ...
    public static TabParamVitaux createEntity(EntityManager em) {
        TabParamVitaux tabParamVitaux = new TabParamVitaux()
            ...
            .sous(DEFAULT_SOUS)
            .poids(DEFAULT_POIDS)
            .examenPhysique(DEFAULT_EXAMEN_PHYSIQUE)
            .examenCompl(DEFAULT_EXAMEN_COMPL)
    ...
    public static TabParamVitaux createUpdatedEntity(EntityManager em) {
        TabParamVitaux tabParamVitaux = new TabParamVitaux()
            ...
            .sous(UPDATED_SOUS)
            .poids(UPDATED_POIDS)
            .examenPhysique(UPDATED_EXAMEN_PHYSIQUE)
            .examenCompl(UPDATED_EXAMEN_COMPL)
    ...
    public void createTabParamVitaux() throws Exception {
        ...
        assertThat(testTabParamVitaux.getExamenPhysique()).isEqualTo(DEFAULT_EXAMEN_PHYSIQUE);
        assertThat(testTabParamVitaux.getExamenCompl()).isEqualTo(DEFAULT_EXAMEN_COMPL);
        assertThat(testTabParamVitaux.getEvolution()).isEqualTo(DEFAULT_EVOLUTION);
    }
    ...
    public void getAllTabParamVitauxes() throws Exception {
        ...
        restTabParamVitauxMockMvc.perform(get("/api/tab-param-vitauxes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].examenPhysique").value(hasItem(DEFAULT_EXAMEN_PHYSIQUE)))
            .andExpect(jsonPath("$.[*].examenCompl").value(hasItem(DEFAULT_EXAMEN_COMPL)))
    ...
    public void getTabParamVitaux() throws Exception {
        ...
        restTabParamVitauxMockMvc.perform(get("/api/tab-param-vitauxes/{id}", tabParamVitaux.getId()))
            ...
            .andExpect(jsonPath("$.examenPhysique").value(DEFAULT_EXAMEN_PHYSIQUE))
            .andExpect(jsonPath("$.examenCompl").value(DEFAULT_EXAMEN_COMPL))
    ...
    public void updateTabParamVitaux() throws Exception {
        ...
        assertThat(testTabParamVitaux.getExamenPhysique()).isEqualTo(UPDATED_EXAMEN_PHYSIQUE);
        assertThat(testTabParamVitaux.getExamenCompl()).isEqualTo(UPDATED_EXAMEN_COMPL);
        assertThat(testTabParamVitaux.getEvolution()).isEqualTo(UPDATED_EVOLUTION);
    }
